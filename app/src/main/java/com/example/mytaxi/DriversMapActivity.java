        ...
        com.google.android.gms.location.LocationListener
{
    ...
    private ValueEventListener AssignetCustomerPositionListener;
    ...
    private void getAssignedCustomerRequest()
    {
        assignedCustomerRef = FirebaseDatabase.getInstance().getReference()
                .child("User").child("Drivers").child(driverID).child("CustomerRideID");
        ...
        assignedCustomerRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                else
                {
                    ...
                    if (AssignetCustomerPositionListener!= null)
                    {
                        AssignedCustomerPositionRef.removeEventListener(AssignetCustomerPositionListener);
                    }
                }
            }
    ...
    private void getAssignedCustomerPosition()
    {
        ...
        AssignetCustomerPositionListener = AssignedCustomerPositionRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists())
                {
